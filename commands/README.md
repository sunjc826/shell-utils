...
1. They are found through `bu`, e.g. `bu new-script ...`. Note that the `bu-` prefix and the `.sh` suffix are stripped out. See [__bu_remove_bu_prefix](../core/bu_core_preinit.sh).
